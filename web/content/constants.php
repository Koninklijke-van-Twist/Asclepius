...
const THEEVRAAGJE_DIRECTORY = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'theevraagje';
const THEEVRAAGJE_IMAGE_FILE = THEEVRAAGJE_DIRECTORY . DIRECTORY_SEPARATOR . 'current.png';
const THEEVRAAGJE_SOURCE_URL = 'https://projects.timfalken.com/theevraagjes/';
