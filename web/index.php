...
require_once __DIR__ . '/content/LaraTranslationProvider.php';
...
<body<?= $isBigscreen ? ' style="overflow:hidden;"' : '' ?> data-api-url="<?= h($apiUrl) ?>"
    ...
    <div class="page">
        ...
        <main class="layout">
            ...
            <?php require __DIR__ . '/content/views/view_role_settings.php'; ?>

            <?php require __DIR__ . '/content/views/view_roles.php'; ?>
            ...
            <?php require __DIR__ . '/content/views/view_email_prefs.php'; ?>

            <?php require __DIR__ . '/content/views/view_changelog.php'; ?>
